 ...
 * @author     halbbit (osi@abwesend.de)
               heavily based on the abandoned version of Heikki Hokkanen <hoxu@users.sf.net>
 */
		...
		if($mode == 'xhtml'){
			...
			switch ($state) {
				case DOKU_LEXER_ENTER :
					...
					$renderer->doc .= '<div class="spoiler"><div class="title">'. $payload .'</div><input type="button" value="Show" onClick="'. $script .'" /><div class="content" style="display: none">';
					// two open div tags
					break;
				case DOKU_LEXER_MATCHED :
					break;
